...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="fp-range" placeholder="YYYY-MM-DD to YYYY-MM-DD" readonly="readonly" name="tanggal" class="form-control flatpickr-range flatpickr-input" required>
        </div>
         <div class="form-group">
        ...
        <div class="form-group">
            ...
            <button type="reset" class="btn btn-warning text-white">  <span class="icon text-white-50">  <i data-feather="alert-triangle"></i></span> KOSONGKAN</button>
        </div>
        </form>
    </div>
</div>

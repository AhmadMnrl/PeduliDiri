            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="/postregister" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="name" placeholder="Masukan NIK (16 Digit)"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="nama"
                                    placeholder="Masukan Username (Untuk Login)" autocomplete="off"
                            ...
                            <div class="form-group">
                                <label for="nama"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="nama" id="nama" placeholder="Masukan Nama Panjang"
                            ...
                            <div class="form-group">
                                <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="password_confirmation" id="pass" minlength="8"
                    ...
                    <div class="signup-image">
                        <figure><img src="{{ asset('login/assets/images/signup-image.jpg') }}" alt="sing up image">
                        </figure>

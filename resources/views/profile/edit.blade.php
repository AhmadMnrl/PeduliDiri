            ...
            <div class="main-body">
                <div class="row gutters-sm">
                    ...
                    <div class="col-md-8">
                        <div class="card mb-3">
                            <div class="card-body">
                                <form action="/propil/update/{{ $propil->id }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="username"
                                                value="{{ $propil->username }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="nik" id="" class="form-control"
                                                value=" {{ $propil->nik }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="nama"
                                                value="{{ $propil->nama }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="email" name="email" id="" class="form-control"
                                                value="{{ $propil->email }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="telp" value="{{ $propil->telp ?? 'NULL' }}" id=""
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <br>
                                            <textarea class="form-control mt-3" name="alamat" id="alamat" cols="65" value=""
                                                rows="4">{{ $propil->alamat ?? 'NULL' }}</textarea>
                                        </div>
                                    </div>
